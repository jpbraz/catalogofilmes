...
class CatalogScreenOld extends StatefulWidget {
  const CatalogScreenOld({Key? key}) : super(key: key);

  @override
  State<CatalogScreenOld> createState() => _CatalogcreenOldState();
}

class _CatalogcreenOldState extends State<CatalogScreenOld> {
  List _movies = [];
